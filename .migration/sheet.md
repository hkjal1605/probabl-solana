...
- apps/ui/src/components/ui/sheet.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
- apps/ui/src/components/layout/SiteHeader.tsx — consumer or primitive dependency migrated to the local component.

Mobile navigation uses render composition. Link-based close controls specify nativeButton=false.
