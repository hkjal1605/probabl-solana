...
- apps/ui/src/components/ui/tooltip.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
- apps/ui/src/components/providers/AppProviders.tsx — consumer or primitive dependency migrated to the local component.
- apps/ui/src/components/ui/info-tooltip.tsx — consumer or primitive dependency migrated to the local component.

Native title attributes become Base tooltips with keyboard focus and an accessible description. Provider uses delay=250, not delayDuration. Obsolete delayed-open selectors removed.
