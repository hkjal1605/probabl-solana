...
- apps/ui/src/components/ui/toggle-group.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
...
- apps/ui/src/components/ui/segmented.tsx — consumer or primitive dependency migrated to the local component.

Values are always arrays. Segmented controls reject an empty selection and explicitly receive busy/disabled state. Orientation is forwarded to the root.
