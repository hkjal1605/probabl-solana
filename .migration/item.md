...
- apps/ui/src/components/ui/item.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
...
Balance rows, wallet details, review summaries and payout rows use Item/ItemContent; domain-specific values remain unchanged.
