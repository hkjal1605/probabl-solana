...
- apps/ui/src/components/ui/skeleton.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
- apps/ui/src/app/loading.tsx — consumer or primitive dependency migrated to the local component.
