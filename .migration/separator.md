...
- apps/ui/src/components/ui/separator.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
- apps/ui/src/components/layout/SiteFooter.tsx — consumer or primitive dependency migrated to the local component.
- apps/ui/src/components/ui/item.tsx — consumer or primitive dependency migrated to the local component.
