...
- apps/ui/src/components/ui/dialog.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
...
- apps/ui/src/components/layout/FundsDialog.tsx — consumer or primitive dependency migrated to the local component.

Triggers use render composition without nested buttons. Claim/payout dialogs cancel dismissal during pending work and hide the close control; tall dialogs scroll.
