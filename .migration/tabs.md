...
- apps/ui/src/components/ui/tabs.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
...
- apps/ui/src/components/ui/line-tabs.tsx — consumer or primitive dependency migrated to the local component.

Orientation is forwarded to Base UI. Line tabs use the stock line variant. Base UI keyboard activation is manual: arrows move focus; Enter/Space activates. Option sets without panels use ToggleGroup instead.
