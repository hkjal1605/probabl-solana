...
- apps/ui/src/components/ui/breadcrumb.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
...
Market navigation uses Breadcrumb composition. The current page remains disabled text per upstream semantics.
