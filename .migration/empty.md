...
- apps/ui/src/components/ui/empty.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
...
Empty and error screens use shadcn Empty composition. LoadingState uses Spinner and a status live region instead of pretending loading is empty.
