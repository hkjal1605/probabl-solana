...
- apps/ui/src/components/ui/table.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
...
- apps/ui/src/modules/MarketDetailPageModule/components/TradeTable.tsx — consumer or primitive dependency migrated to the local component.
...
- apps/ui/src/components/portfolio/ClaimTable.tsx — consumer or primitive dependency migrated to the local component.
