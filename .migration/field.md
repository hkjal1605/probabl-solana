...
- apps/ui/src/components/ui/field.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
...
Forms use FieldSet/FieldGroup/Field and FieldLabel. Quantity validation has matching data-invalid and aria-invalid. Existing signed-field validation is unchanged.
