...
- apps/ui/src/components/ui/progress.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
...
Order-fill percentage remains bounded and derived from raw-unit ratios; lifecycle progress is explicitly labelled. Diverging impact and order-book depth are not misrepresented as task progress.
