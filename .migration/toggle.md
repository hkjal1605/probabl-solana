...
- apps/ui/src/components/ui/toggle.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
- apps/ui/src/components/ui/toggle-group.tsx — consumer or primitive dependency migrated to the local component.

Uses Base UI pressed state; obsolete Radix data-state=on styling removed.
