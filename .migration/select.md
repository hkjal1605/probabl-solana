...
- apps/ui/src/components/ui/select.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
...
Every consumer provides SelectGroup and display items; nullable callbacks are guarded. Token labels no longer depend on the popup mounting.
