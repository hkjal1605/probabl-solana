...
- apps/ui/src/components/ui/navigation-menu.tsx:1 — official Base/Nova component, local cn import, formatting and narrowly documented lint compatibility.
- apps/ui/src/components/layout/SiteHeader.tsx — consumer or primitive dependency migrated to the local component.

Desktop links use NavigationMenu composition. Base UI uses its standard navigation behavior/delay. The unused upstream NavigationMenuIndicator is inert (no Base counterpart); there are no indicator consumers.
