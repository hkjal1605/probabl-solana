/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: b40f5d5d30f286274d0a29736021f029)
// Runtime types generated with workerd@1.20260907.1 2026-09-07 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	PROBABL_HOSTING: "cloudflare";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROBABL_HOSTING">> {}
}
